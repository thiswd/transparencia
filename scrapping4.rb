...
filepath = 'data/servidores4.json'
filepath2 = 'data/servidores_sem_salario4.json'

(1..26).each do |page|

  print page

  url = "http://www.portaltransparencia.gov.br/servidores/OrgaoExercicio-ListaServidores.asp?CodOrg=45208&Pagina=#{page}"
